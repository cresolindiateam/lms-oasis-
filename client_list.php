...
<div class="team_member_password_change_modal">
  ...
  <div class="form-group" style="margin-bottom:10px">
                   ...
                   <input type="text" name="edit_client_members" placeholder="" class="form-control" id="client_members_edit"/>
...
function clientedit(clientid)
{
    $("#edit_client_id").val(clientid);
     $.ajax({
       ...
       var clientmember=response['ClientMember'];
    ...
    if(status==1){
       ...
       $("#client_members_edit").val(clientmember);
    }
    }
});   
